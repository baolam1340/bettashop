...
class chatController {
  // ham xu ly chat, moi lan chat them vao moi chat dc
          ...
          $or: [
            {
              $and: [
                {
                  receverId: { $eq: "65e09606ddefc884e474eba3" },
                },
                {
                  senderId: {
                    $eq: userId,
