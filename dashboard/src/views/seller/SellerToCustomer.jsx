...
const SellerToCustomer = () => {
  ...
  const send = (e) => {
    ...
    dispatch(
      send_message({
        senderId: "65e09606ddefc884e474eba3",
  ...
  return (
    ...
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full bg-dark px-4 border  py-4 rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-secondary rounded md:bg-transparent overflow-y-auto">
              ...
              {customers.map((c, i) => (
                <Link
                  ...
                  className={`h-[60px] flex text-decoration-none justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer `}
                >
              ...
              <div className="bg-secondary h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
                {customerId ? (
                  ...
                  <div className="w-full h-full flex justify-center items-center flex-col gap-2 text-white">
                    <span>
                      <WechatOutlined className="h1 display-1" />
                    </span>
                    <span className="h3">Chọn người mua muốn chat</span>
                  </div>
                )}
              </div>
            </div>
