...
const Category = () => {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      ...
      <div className="flex flex-wrap w-full container bg-secondary rounded">
        <div className="w-full lg:w-7/12 mt-2">
        ...
        >
          <div className="w-full pl-5 mt-2 mb-2 ">
            <div className="bg-dark border h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
